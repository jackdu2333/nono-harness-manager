...
- Auto-discover local AI clients when detectable: Codex, Antigravity, WorkBuddy, Newmax, Cursor, Windsurf, Claude Code, Claude Desktop, Gemini-based agents
...
- Supported log adapters: **Codex**, **Antigravity**, **WorkBuddy**, **Newmax**, **Claude Code**
